...
export default class Reciept extends Component {
    render() {
        ...
        <Text 
        style={styles.txt8}
        >Payment from Mina Ezzat to Ibraam Emad for the third milestone of the O-Projects Project. </Text>
        ...
        <Text style={styles.txt3}>Amount</Text>
            ...
            <Image source={{uri: 'qnb'}} style={styles.img2} resizeMode="contain"/>
            <View style={{marginLeft:w*0.05}}>
            <Text style={styles.txt7}>Withdraw to</Text>
                    <Text style={styles.txt6}>2920 727 010 1235</Text>
            </View>
                ...
                // start={[0, 1]} end={[1, 0]}
                >
                    <TouchableOpacity style={styles.btn} onPress={()=>this.props.navigation.navigate('Wallet')}>

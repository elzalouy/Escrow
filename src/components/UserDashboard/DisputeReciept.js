...
export default class DisputeReciept extends Component {
    render() {
        return (
        ...
        <Text style={styles.txt3}>Amount</Text>
            ...
            <Text style={styles.txt7}>Deposit Fund</Text>
                ...
                // start={[0, 1]} end={[1, 0]}
                >
                    <TouchableOpacity style={styles.btn} onPress={()=>this.props.navigation.navigate('DisputeTimeline')}>
                        <Text style={styles.txt5}>Continue</Text>
                        <View style={styles.iconContainer}>
                        <Icon
                        name='arrow-right' size={normalize(15)} color="#7889FF"/> 
                        </View>
                    </TouchableOpacity>
                    </LinearGradient>
